...
struct TMat4 {
    ...
    static TMat4<T> Perspective(float vertFov, float aspect, float near, float far) {
        Eigen::Matrix4f pers;
        pers << 1.f, .0f, .0f, .0f,
               .0f, 1.f, .0f, .0f,
        ...
        yScale << recipY, .0f, .0f, .0f,
                  .0f, recipY, .0f, .0f,
                  .0f, .0f, 1.f, .0f,
                  .0f, .0f, .0f, 1.f;

        Eigen::Matrix4f aspectAdjust;
        aspectAdjust << 1.f/aspect, .0f, .0f, .0f,
                        .0f, 1.f, .0f, .0f,
                        .0f, .0f, 1.f, .0f,
                        .0f, .0f, .0f, 1.f;
